...
- ✨ 新增选择模式，支持复制终端内容
  ...
  - 逐行点击选择要复制的内容
  - 支持全选、清除选择
  - 桌面端支持 Shift+点击快速选择范围
- ✨ 虚拟键盘按键支持长按连发（方向键、退格键）

**优化改进**
- 🎯 移除 Ctrl+D 按钮（防止误操作关闭 tmux 会话）
- 🎯 移除上翻下翻按钮（简化界面，使用滚动模式替代）
- 🎯 优化选择模式界面，支持桌面端和移动端
...
**新功能**
- ✨ 添加终端滚动模式，支持 tmux copy mode 滚动查看历史输出（默认 1000 行，可配置）
- ✨ 添加可视化滚动条，支持鼠标滚轮操作
- ✨ 虚拟键盘新增专门的滚动模式切换按钮
- ✨ 支持键盘快捷键：Ctrl+B 切换滚动模式
